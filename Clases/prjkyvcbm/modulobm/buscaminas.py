...
def conteo_minas_izquierda(tablero):
    """
        Conteo de minas en la parte de la izquierda
    """
    filas = len(tablero)
    for i in range(1, filas - 1):
        if tablero [i][0] != MINA:
...
def conteo_minas_derecha(tablero):
    """
        Conteo de minas en la parte de la derecha
    """
    filas = len(tablero)
    for i in range(1, filas - 1):
        if tablero [i][-1] != MINA:
...
# funcion para hallar las minas en la parte superior
# sin tener en cuenta la esquina superior derecha 
# y la esquina superior izquierda
def conteo_minas_superior(tablero):
    """
        Conteo de minas en la parte superior
    """
    columnas = len(tablero[0])
    for j in range(1, columnas - 1):
        if tablero [0]  [j] != MINA:
...
# funcion para hallar las minas en la parte inferior
# sin tener en cuenta la esquina inferior derecha 
# y la esquina inferior izquierda
def conteo_minas_inferior(tablero):
    """
        Conteo de minas en la parte inferior
    """
    columnas = len(tablero[0])
    for j in range(1, columnas - 1):
        if tablero [-1]  [j] != MINA:
...
# funcion para hallar las minas en la esquina superior izquierda
def conteo_minas_esquina_superior_izquierda(tablero):
    """
        Conteo de minas en la esquina superior izquierda
    """
    if tablero [0][0] != MINA:
        if tablero [0]      [1] == MINA:
            tablero[0]      [0] +=1
...
# funcion para hallar las minas en la esquina inferior izquierda
def conteo_minas_esquina_inferior_izquierda(tablero):
    """
        Conteo de minas en la esquina inferior izquierda
    """
    if tablero [-1][0] != MINA:
        if tablero [-1]      [1] == MINA:
            tablero[-1]      [0] +=1
...
# funcion para hallar las minas en la esquina superior derecha
def conteo_minas_esquina_superior_derecha(tablero):
    """
        Conteo de minas en la esquina superior derecha
    """
    if tablero [0][-1] != MINA:
        if tablero [0]      [-2] == MINA:
            tablero[0]      [-1] +=1
...
def conteo_minas_esquina_inferior_derecha(tablero):
    """
        Conteo de minas en la esquina inferior derecha
    """
    if tablero [-1][-1] != MINA:
        if tablero [-1]      [-2] == MINA:
            tablero[-1]      [-1] +=1
